...
export default async function lenwyHandler(lenwy: WASocket, m: any) {
  ...
  const admin: string[] = []; // daftar JID admin
  const lenwyreply = (teks: string) => lenwy.sendMessage(sender!, { text: teks }, { quoted: msg });
